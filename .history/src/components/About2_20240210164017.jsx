...
import heroabout from "../icons/Container2.png";
...
const About2 = () => {
  ...
  return (
    <div>
      {/* <div className=""> */}
      <div className="   mx-[20px] md:mx-[100px] h-[470px] flex md:flex-row flex-col  items-center gap-[81px] ">
        <div className="w-[614px] h-[426px]    ">
          ...
          <motion.div
            ...
            initial="hidden"
            whileInView="visible"
            className="flex flex-col p-[12px] items-start absolute mt-20 left-[0px] md:left-[540px] text-white bg-primary w-[200px] h-[86px]  rounded-xl"
          >
            <motion.div
              variants={container}
              initial="hidden"
          ...
          {/* <div className=" "> */}
          {/* <div className="w-[593px] h-[404px]  bg-cover  bg-[url('../icons/Container.png')] shadow-md"></div> */}
          <img
            className="w-[335px] h-[312px] md:w-[593px] md:h-[404px]  "
            src={heroabout}
            alt=""
          />
          {/* </div> */}
          <motion.div
            ...
            initial="hidden"
            whileInView="visible"
            className="flex flex-col absolute -mt-[120px] left-[220px]  bg-amber-300 w-[250px] h-[125px] text-center rounded-xl p-[18px]"
          >
        ...
        <div className=" bg-pink-400">
          <div
            data-aos="fade-left"
            className="flex flex-col  gap-[24px] bg-teal-900 mr-[55px] h-[350px] w-[494px]"
          >
