...
const Contact = () => {
  return (
    <div className="px-[40px] py-[28px] md:py-[400px]">
      <div
        data-aos="fade-up"
        className=" flex items-center justify-center text-center flex-col gap-[24px]  h-[242px]  rounded-lg bg-black text-white mt-[100px]"
      >
