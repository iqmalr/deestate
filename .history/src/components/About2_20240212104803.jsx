...
const About2 = () => {
  ...
  return (
    <div className="border-t-2">
      <div className="   mx-[20px] md:mx-[100px] h-auto md:h-[470px] flex md:flex-row flex-col  items-center  md:gap-[81px]  ">
        <div className=" h-[426px]    ">
          <img
            data-aos="fade-right"
            className="absolute w-[290px] md:w-[440px] -z-10 left-[25px] md:left-[110px] h-[250px]  md:h-[330px] mt-[10px]  "
            src={herohitam}
            alt=""
          />
          ...
          <motion.div
            ...
            initial="hidden"
            whileInView="visible"
            className="flex flex-col p-[12px] items-start absolute mt-20 left-[170px] md:left-[450px] text-black bg-white opacity-80 shadow-md w-[200px] h-[86px]  rounded-xl"
          >
            <motion.div
              variants={container}
              initial="hidden"
          ...
          <motion.div
            ...
            initial="hidden"
            whileInView="visible"
            className="flex flex-col absolute -mt-[120px] left-[50px] md:left-[170px]  text-black bg-white opacity-80 shadow-md w-[250px] h-[125px] text-center rounded-xl p-[18px]"
          >
            <img className=" h-[36px] w-[36px]" src={profile1} alt="" />
            <div className="flex h-[43px] items-center justify-between ">
              <div className="flex items-start flex-col w-[133px] ">
        ...
        <div
          data-aos="fade-left"
          className="flex flex-col  justify-between   h-[350px] md:-mt-10 md:mr-[55px] "
        >
          ...
          >
            <div className="flex items-center justify-between text-center">
              <div className="flex flex-col items-center justify-center">
                <div className="w-[80px] text-5xl font-bold text-primary ">
                  {counterOn && (
                    <CountUp start={0} end={200} duration={3} delay={1} />
                  )}
                </div>
                <div className=" w-[80px] top-0 text-base ">Awward Winning</div>
              </div>
              <div className="flex flex-col items-center justify-center">
                <div className="w-[125px] text-5xl font-bold text-primary ">
                  {counterOn && (
              ...
              <div className="flex flex-col items-center justify-center">
                <div className="w-[100px] text-5xl font-bold text-primary ">
                  {counterOn && (
