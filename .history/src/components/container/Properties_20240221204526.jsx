    ...
    <div className=" mb-10">
      ...
      >
        <div className="flex justify-between items-center h-[72px] bg-red-500 ">
          ...
          <button class="relative inline-block transition-all duration-500 transform border-none bg-blue-500 hover:bg-blue-600 text-white text-center text-2xl p-4 w-52 cursor-pointer m-8 shadow-md hover:pl-8 hover:pr-24">
            Your Button Text
            <span class="absolute opacity-0 top-1/2 right-[-20px] transform -translate-y-1/2 transition duration-500 group-hover:opacity-100 group-hover:right-10">
              »
            </span>
          </button>
        </div>
