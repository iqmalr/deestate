      ...
      <div className="section py-[75px]" id="home">
        <div className="flex items-center justify-center ">
          <img
            ...
            alt=""
          />
          <div className="container w-auto t-[50px] md:t-[140px] px-5 md:px-[165px] absolute  flex flex-col justify-between items-center bg-slate-700">
            <h5 className=" font-bold text-[24pt] md:text-[58rem] leading-none text-black text-center tracking-tight pb-5 px-[100px]">
