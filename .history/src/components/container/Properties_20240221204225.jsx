    ...
    <div className=" mb-10">
      ...
      >
        <div className="flex justify-between items-center h-[72px] bg-red-500 ">
          ...
          <button class="relative transition duration-500 hover:pl-8 hover:pr-24">
            Your Button Text
            <span class="absolute opacity-0 top-14 right-[-20px] transition duration-500 group-hover:opacity-1 group-hover:right-10">
              »
            </span>
          </button>
        </div>
