    ...
    <div className="section" id="home">
      ...
      <div className="text-center text-xl">
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          className=" bg-amber-400 h-[200px] md:h-[48px] w-auto text-primary text-opacity-50 flex flex-col md:flex-row justify-between items-center text-4xl  font-bold "
        >
