...
const Home = () => {
  ...
  return (
    <div className="section my-[75px]" id="home">
      ...
      <div className="text-center text-xl">
        <p className="text-base font-semibold">Trusted by companies</p>
        <motion.div
          variants={container}
          initial="hidden"
          whileInView="visible"
          className=" mx-[20px] md:mx-[100px]  bg-amber-400 h-[200px] md:h-[48px]  text-primary text-opacity-50 flex flex-col md:flex-row justify-between items-center text-4xl  font-bold "
        >
