      ...
      <div className="section py-[75px]" id="home">
        <div className="flex items-center justify-center ">
          <img
            ...
            alt=""
          />
          <div className="container w-auto t-[50px] md:t-[140px] px-5 md:px-[115px] absolute  flex flex-col justify-between items-center bg-slate-700">
            ...
            <h3 className=" font-bold text-base px-5 md:px-[81px] md:text-xl pb-12 text-center text-[#4141]">
