...
const About2 = () => {
  ...
  return (
    <div className="   mx-[20px] md:mx-[100px] h-auto md:h-[470px] flex md:flex-row flex-col  items-center  md:gap-[81px] border-t-4 ">
      <div className=" h-[426px]    ">
        <img
          data-aos="fade-right"
          className="absolute w-[290px] md:w-[490px] -z-10 left-[25px] md:left-[110px] h-[250px]  md:h-[330px] mt-[10px]  "
          src={herohitam}
          alt=""
        />
