...
const Service = () => {
  ...
  return (
    <div className="bg-[#e9efff] md:bg-transparent">
      <img
        className="absolute hidden md:block lg:block w-[135px] right-0 bottom-0"
        src={shape1}
        alt=""
      />
      <img
        className="absolute hidden md:block lg:block left-0 top-[1000px] h-[120px] w-auto"
        src={shape2}
        alt=""
      />
      <img
        className="absolute  hidden md:block lg:block w-[135.72px] left-0 top-0"
        src={shape3}
        alt=""
      />
      <img
