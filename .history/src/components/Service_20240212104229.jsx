  ...
  return (
    <div className="bg-[#e9efff] border-t-2 mt-10">
      <img
        ...
        className="absolute hidden md:block lg:block w-[135px] right-0 top-[1950px]"
        src={shape1}
        alt=""
      />
      <img
        data-aos="fade-up-right"
        className="absolute hidden md:block lg:block left-0 top-[1950px] h-[120px] w-auto"
        src={shape2}
        alt=""
      />
      <img
        data-aos="fade-up-right"
        className="absolute  hidden md:block lg:block w-[135.72px] left-0 top-[1540px]"
        src={shape3}
        alt=""
      />
      <img
        data-aos="fade-down-left"
        className="absolute  hidden md:block lg:block w-[70px] right-[100px] top-[1540px]"
        src={shape4}
        alt=""
      />
      {/* <img
