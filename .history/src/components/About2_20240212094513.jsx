    ...
    <div className="   mx-[20px] md:mx-[100px] h-[470px] flex md:flex-row flex-col  items-center gap-[30px] md:gap-[81px] ">
      <div className=" h-[426px]    ">
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          className="flex flex-col p-[12px] items-start absolute mt-20 left-[0px] md:left-[450px] text-white bg-primary w-[200px] h-[86px]  rounded-xl"
        >
          <motion.div
            variants={container}
            initial="hidden"
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          className="flex flex-col absolute -mt-[120px] left-[30px] md:left-[170px]  bg-amber-300 w-[250px] h-[125px] text-center rounded-xl p-[18px]"
        >
