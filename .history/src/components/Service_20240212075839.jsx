...
const Service = () => {
  ...
  return (
    <div className="flex flex-col items-center  justify-between py-[70px] w-full h-auto md:h-[550px] bg-[#e9efff] ">
      <div className="flex flex-col items-center gap-[15px]  h-[131px] bg-red-400">
