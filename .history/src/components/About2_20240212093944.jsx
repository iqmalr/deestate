...
const About2 = () => {
  ...
  return (
    <div className="   mx-[20px] md:mx-[100px] h-[470px] flex md:flex-row flex-col  items-center gap-[30px] md:gap-[81px] bg-slate-500 ">
      <div className=" h-[426px]    ">
        <img
          className="absolute -z-10 right-[15px] md:right-[5px] h-[312px]  md:h-[404px] mt-3  "
          src={heroabout}
          alt=""
        />
