...
const Service = () => {
  ...
  // bg - Solitude;
  return (
    <div className="bg-[#e9efff] border-t-2 mt-10">
      <img
        data-aos="fade-down"
        className="absolute hidden md:block lg:block w-[135px] right-0 top-[2000px]"
        src={shape1}
        alt=""
      />
      <img
        data-aos="fade-up-right"
        className="absolute hidden md:block lg:block left-0 top-[2000px] h-[120px] w-auto"
        src={shape2}
        alt=""
      />
      <img
        data-aos="fade-up-right"
        className="absolute  hidden md:block lg:block w-[135.72px] left-0 top-[1640px]"
        src={shape3}
        alt=""
      />
      <img
        data-aos="fade-down"
        className="absolute  hidden md:block lg:block w-[70px] right-[100px] top-[1690px]"
        src={shape4}
        alt=""
      />
      {/* <img
      ...
      <div className="flex flex-col items-center gap-9 justify-between py-[70px] w-full h-auto md:h-[550px]  ">
        <div className="flex flex-col items-center justify-between  h-[131px] ">
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          className="  flex flex-col md:flex-row justify-center  gap-[67px]"
        >
