...
const Contact = () => {
  return (
    <div
      // data-aos="fade-up"
      className=" flex items-center justify-center text-center flex-col gap-[24px]  h-[242px]  rounded-lg bg-black text-white mx-5 md:mx-[460px] px-4 md:px-[45px] mt-10 "
    >
